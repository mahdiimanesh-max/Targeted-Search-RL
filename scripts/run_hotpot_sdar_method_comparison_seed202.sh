...
TAG=hotpot_sdar_qwen25_1p5b_12x2_seed202
...
echo "============================================================"
echo "1/5 Base + SDAR skill-prompt evaluation, seed 202"
echo "============================================================"
...
echo "============================================================"
echo "2/5 Train SDAR + PrefixIG-TPO online LoRA, seed 202"
echo "============================================================"
...
echo "============================================================"
echo "3/5 Evaluate SDAR + PrefixIG-TPO online LoRA, seed 202"
echo "============================================================"
"$PY" scripts/eval_hotpotqa_mini.py \
  "${COMMON_EVAL[@]}" \
  --adapter-path "outputs/adapters/${TAG}_prefixig_tpo" \
...
echo "============================================================"
echo "4/5 Train SDAR + A-TGPO proxy online LoRA, seed 202"
echo "============================================================"
"$PY" scripts/online_hotpotqa_prefixig_tpo_lora.py \
  "${COMMON_TRAIN[@]}" \
...
echo "============================================================"
echo "5/5 Evaluate SDAR + A-TGPO proxy online LoRA, seed 202"
echo "============================================================"
"$PY" scripts/eval_hotpotqa_mini.py \
  "${COMMON_EVAL[@]}" \
  --adapter-path "outputs/adapters/${TAG}_atgpo_proxy" \
